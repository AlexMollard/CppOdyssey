...
|-------------------|--------------|
|![Visual Studio Project Properties](res/VisualStudioProjectProperties.png)|![Visual Studio Project Properties Menu](res/VisualStudioProjectPropertiesMenu.png) |

You should see a window that looks like this:

![Visual Studio Project Properties Window](res/VisualStudioProjectPropertiesWindow.png)
...
![Visual Studio Project Properties Configuration](res/VisualStudioProjectPropertiesConfiguration.png)
